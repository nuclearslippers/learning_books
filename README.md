...
- [美观表格绘制网站](https://www.uwarp.design/uchart)
    > 绘制美观的表格

- [数据库管理工具](https://dbeaver.io/)
    > 开源免费的数据库管理工具，大家用了都说好
...
- [世界温度地图](https://zoom.earth/maps/temperature/)
    > 显示全球各个城市的温度。并且有热力图。
- [大模型+二次元MMD](https://github.com/AmyangXYZ/PoPo)
    > 使用自然语言发出指令（"弯腰"、"大笑"等等），控制网页上的 3D 模型（demo是深空之眼，没想到海外也有大眼）
- [手机博物馆](https://chaz.fun/)
    > 手机博物馆，旧手机3D模型的网页查看器。
- [AI主题地图](https://mapedia.cc/)
    > 输入文字，AI寻找相关地点并介绍，并在地图上展示。例如，“苏东坡的足迹”，“中国首都迁移历史”等。
- [海底光纤地图](https://www.submarinecablemap.com/)
    > 内容如其名
...
- [github电子书](https://gitprint.me/)
    > 将一个GITHUB仓库变成一个PDF电子书的形式，适合用作大语言模型训练
...
## 潜力项目
- [去哪儿？MeetSpot](https://github.com/JasonRobertDestiny/MeetSpot)
    > 用户输入多个参与者的出发位置，它会推荐对大家距离合适的聚会场所。
    > 问题：目前还不支持移动端。
